...
$(function(){
    $('.header .logo').mousedown(function(){
        if(isOpen){
            $(this).rotate({angle:0, animateTo:180, duration:1500});
            $(this).parent().animate({top:-80}, {duration:1000, easing:'easeOutBounce'});
            $(this).animate({top:40}, {duration:1000, easing:'easeOutBounce'});
            isOpen=false;
        }else{
            $(this).rotate({angle:180, animateTo:360, duration:1500});
            $(this).parent().animate({top:0}, {duration:1000, easing:'easeOutBounce'});
            $(this).animate({top:10}, {duration:1000, easing:'easeOutBounce'});
            isOpen=true;            
        }    
    })
});
