...
### 練習重點
```
使用jQueryRotate設計使用者互動.
```

### 執行結果:
![GitHub Logo](/imgs/results10-3.jpg)
...
$(function(){
    ...
    $('.card').mouseenter(function(){        
        $(this).stop().rotate({angle:0, animateTo:10, duration:700}); 
    });	

    // 滑鼠移出	
    $('.card').mouseleave(function(){        
        $(this).stop().rotate({angle:10, animateTo:0, duration:500}); 
    });		
});
```
