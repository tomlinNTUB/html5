...
#####執行結果:
![GitHub Logo](/imgs/results04-2.jpg)



#####網路資源(google free icons):
...
```
   ...
   |
   |___<images>
   |     |___ home-black.png     (24像素*24像素)
   |     |___ home-white.png  
   |     |
   |     |___ people-black.png   (24像素*24像素)
   |     |___ people-white.png  
   |     |
   |     |___ nature-black.png   (24像素*24像素)
   |     |___ nature-white.png  
   |     |
   |     |___ food-black.png     (24像素*24像素)
   |     |___ food-white.png  
   |     |
   |     |___ culture-black.png  (24像素*24像素)
   |     |___ culture-white.png  
   |        
   |___index.html   
```
...
<body>
    ...
    <div class="container">
        ...
        <div class="navbar">
            <ul>
                <a href="#"><li id="home"><div id="home" class="nav_icon"></div>首頁</li></a>
                <a href="#"><li id="people"><div id="people" class="nav_icon"></div>居民</li></a>
                <a href="#"><li id="nature"><div id="nature" class="nav_icon"></div>自然</li></a>
                <a href="#"><li id="food"><div id="food" class="nav_icon"></div>飲食</li></a>
                <a href="#"><li id="culture"><div id="culture" class="nav_icon"></div>文化</li></a>
            </ul>
        </div>        
...
div#people{
    background:url(../images/people-black.png);	
}

div#nature{
    background:url(../images/nature-black.png);	
}

div#food{
    background:url(../images/food-black.png);	
}

div#culture{
    background:url(../images/culture-black.png);	
}
...
li#home:hover div#home{
    background:url(../images/home-white.png);		
}

li#people:hover div#people{
    background:url(../images/people-white.png);		
}

li#nature:hover div#nature{
    background:url(../images/nature-white.png);		
}

li#food:hover div#food{
    background:url(../images/food-white.png);		
}

li#culture:hover div#culture{
