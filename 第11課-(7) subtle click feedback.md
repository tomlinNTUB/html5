...
## (7) subtle click feedback 


##### 執行結果:
![GitHub Logo](/imgs/results11-7.jpg)
...
**以第10課-(2)的網頁為基礎, 增加以下:
 ...
   |___<css>  (複製官網資料夾及內容)
   |     |
   |     |___ my.component.css  (自行增加)    
   |
   |___<fonts>  (複製官網資料夾及內容)  
   |
   |___<js>  (複製官網資料夾及內容)
   |     |
   |     |___ my.classie.js   (自行增加)     
   |
...
<link rel="stylesheet" type="text/css" href="css/my.component.css" />
.
.
.
. (加入js)
