...
### 執行結果:
![GitHub Logo](/imgs/results10-2.jpg)
...
$(function(){
    ...
    $('.card').mouseenter(function(){        
        $(this).stop().animate({opacity:0.6}, {duration:1000, easing:'easeOutExpo'}); 
    });	

    // 滑鼠移出	
    $('.card').mouseleave(function(){        
        $(this).stop().animate({opacity:1}, {duration:50});
    });		
});
```
